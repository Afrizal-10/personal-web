<?php
include "koneksi.php";  // pastikan ini dipanggil sebelum pakai $db
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main class="max-w-3xl mx-auto p-6 bg-white rounded shadow mt-8 flex-grow">
  <h2 class="text-xl font-bold mb-4 text-blue-700">Tentang Saya</h2>
  <div class="space-y-6">
    <?php
    $sql = "SELECT * FROM tbl_about ORDER BY id_about DESC";
    $query = mysqli_query($db, $sql);  // pastikan $db sudah terdefinisi
