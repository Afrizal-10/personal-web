...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4 flex-grow">
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-12">
            <div class="text-lg text-gray-800 mb-4">
                Halo, <strong class="text-blue-700"><?php echo htmlspecialchars($_SESSION['username']); ?></strong>! Apa kabar? 😊
            </div>
