...
<div class="flex max-w-7xl mx-auto px-4 w-full flex-grow">

    <aside class="w-1/4 bg-white rounded shadow p-4 mt-6">
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6 mt-6">
